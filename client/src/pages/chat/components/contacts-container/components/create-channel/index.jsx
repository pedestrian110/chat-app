...
import { CREATE_CHANNEL_ROUTE, GET_ALL_CONTACTS_ROUTES } from "@/utils/constant.js";
        ...
        <Tooltip>
          <TooltipTrigger>
            <FaPlus className="text-neutral-400 font-light top-opacity-90 text-sm
             hover:text-neutral-100 cursor-pointer transition-all duration-300" onClick={()=>setNewChannelModal(true)}/>
          </TooltipTrigger>

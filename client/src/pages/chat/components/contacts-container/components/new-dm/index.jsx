...
import { SEARCH_CONTACTS_ROUTES } from "@/utils/constant.js";
  ...
  return (
    <>
      <TooltipProvider>
        <Tooltip>
          <TooltipTrigger>
            <FaPlus className="text-neutral-400 font-light top-opacity-90 text-sm
             hover:text-neutral-100 cursor-pointer transition-all duration-300" onClick={()=>setOpenNewContactModel(true)}/>
          </TooltipTrigger>
      ...
      <Dialog open={openNewContactModel} onOpenChange={setOpenNewContactModel}>
            <DialogContent className="bg-[#181920] border-none text-white w-[400px] h-[400px] flex flex-col">
                ...
                {
                    searchedContacts.length <= 0 && (<div className="flex-1 md:bg-[#1c1d25] md:flex mt-5 md:mt-0 flex-col justify-center items-center hidden duration-1000 transition-all">
                    <Lottie
